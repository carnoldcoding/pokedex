...
var createCard = function (pokemon) {
...
var search = function (query) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchPokemon(query)];
...
searchbarDOM === null || searchbarDOM === void 0 ? void 0 : searchbarDOM.addEventListener("keydown", function (e) { return __awaiter(void 0, void 0, void 0, function () {
    var inputElement, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                resultsDOM.innerHTML = "<div class=\"loader\"></div>";
                return [4 /*yield*/, search(inputElement.value.toLowerCase())];
            case 1:
                result = _a.sent();
                if (result) {
